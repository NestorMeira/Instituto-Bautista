...
const Primero = () => {
  ...
  const [categoria, setCategoria] = useState('Primero');
  ...
  const fetchData = async () => {
    const querySnapshot = await getDocs(query(collection(db, 'novedades'), where("categoria", "==", "Primero")));
