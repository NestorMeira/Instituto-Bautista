...
const Tercero = () => {
  ...
  const [categoria, setCategoria] = useState('Tercero');
  ...
  const fetchData = async () => {
    const querySnapshot = await getDocs(query(collection(db, 'novedades'), where("categoria", "==", "Tercero")));
